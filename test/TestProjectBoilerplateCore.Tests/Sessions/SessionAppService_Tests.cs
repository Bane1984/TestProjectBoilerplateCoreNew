...
using Shouldly;
using Xunit;
using TestProjectBoilerplateCore.Sessions;

namespace TestProjectBoilerplateCore.Tests.Sessions
{
    public class SessionAppService_Tests : TestProjectBoilerplateCoreTestBase
    {
