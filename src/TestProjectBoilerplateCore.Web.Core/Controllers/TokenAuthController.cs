...
using Abp.UI;
using TestProjectBoilerplateCore.Authentication.External;
...
using TestProjectBoilerplateCore.Models.TokenAuth;
using TestProjectBoilerplateCore.MultiTenancy;

namespace TestProjectBoilerplateCore.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : TestProjectBoilerplateCoreControllerBase
    {
