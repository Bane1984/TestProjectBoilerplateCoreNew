...
namespace TestProjectBoilerplateCore
{
    ...
    public class TestProjectBoilerplateCoreWebCoreModule : AbpModule
    {
        ...
        public TestProjectBoilerplateCoreWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                 .CreateControllersForAppServices(
                     typeof(TestProjectBoilerplateCoreApplicationModule).GetAssembly()
                 );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestProjectBoilerplateCoreWebCoreModule).GetAssembly());
        }
    }
}
