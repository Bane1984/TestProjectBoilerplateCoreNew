...
namespace IdentityServer4.Quickstart.UI
{
    ...
    [SecurityHeaders]
    [AllowAnonymous]
    public class AccountController : AbpController //nalazi se u Abp.AspNetCore.Mvc.Controllers
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var validation = await _signInManager.PasswordSignInAsync(user, model.Password, model.RememberLogin, false);
